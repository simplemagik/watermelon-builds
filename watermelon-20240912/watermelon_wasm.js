...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["cj"];
    addOnInit(wasmExports["Zi"]);
...
var wasmImports = {
  Yi: _YaGamesPrivate_Adv_GetBannerAdvStatus,
  Xi: _YaGamesPrivate_Adv_HideBannerAdv,
  Wi: _YaGamesPrivate_Adv_ShowBannerAdv,
  Vi: _YaGamesPrivate_Adv_ShowFullscreenAdv,
  Ui: _YaGamesPrivate_Adv_ShowRewardedVideo,
  Ti: _YaGamesPrivate_Banner_Init,
  Si: _YaGamesPrivate_Clipboard_WriteText,
  Ri: _YaGamesPrivate_DeviceInfo_IsDesktop,
  Qi: _YaGamesPrivate_DeviceInfo_IsMobile,
  Pi: _YaGamesPrivate_DeviceInfo_IsTV,
  Oi: _YaGamesPrivate_DeviceInfo_IsTablet,
  Ni: _YaGamesPrivate_DeviceInfo_Type,
  Mi: _YaGamesPrivate_Environment,
  Li: _YaGamesPrivate_Event_Dispatch,
  Ki: _YaGamesPrivate_Event_On,
  Ji: _YaGamesPrivate_Features_GameplayAPI_Start,
  Ii: _YaGamesPrivate_Features_GameplayAPI_Stop,
  Hi: _YaGamesPrivate_Features_LoadingAPI_Ready,
  Gi: _YaGamesPrivate_Feedback_CanReview,
  Fi: _YaGamesPrivate_Feedback_RequestReview,
  Ei: _YaGamesPrivate_GetFlags,
  Di: _YaGamesPrivate_GetLeaderboards,
  Ci: _YaGamesPrivate_GetPayments,
  Bi: _YaGamesPrivate_GetPlayer,
  Ai: _YaGamesPrivate_GetStorage,
  zi: _YaGamesPrivate_IsAvailableMethod,
  yi: _YaGamesPrivate_Leaderboards_GetDescription,
  xi: _YaGamesPrivate_Leaderboards_GetEntries,
  wi: _YaGamesPrivate_Leaderboards_GetPlayerEntry,
  vi: _YaGamesPrivate_Leaderboards_SetScore,
  ui: _YaGamesPrivate_OpenAuthDialog,
  ti: _YaGamesPrivate_Payments_ConsumePurchase,
  si: _YaGamesPrivate_Payments_GetCatalog,
  ri: _YaGamesPrivate_Payments_GetPurchases,
  qi: _YaGamesPrivate_Payments_Purchase,
  pi: _YaGamesPrivate_Player_GetData,
  oi: _YaGamesPrivate_Player_GetID,
  ni: _YaGamesPrivate_Player_GetIDsPerGame,
  mi: _YaGamesPrivate_Player_GetMode,
  li: _YaGamesPrivate_Player_GetName,
  ki: _YaGamesPrivate_Player_GetPayingStatus,
  ji: _YaGamesPrivate_Player_GetPersonalInfo,
  ii: _YaGamesPrivate_Player_GetPhoto,
  hi: _YaGamesPrivate_Player_GetSignature,
  gi: _YaGamesPrivate_Player_GetStats,
  fi: _YaGamesPrivate_Player_GetUniqueID,
  ei: _YaGamesPrivate_Player_IncrementStats,
  di: _YaGamesPrivate_Player_SetData,
  ci: _YaGamesPrivate_Player_SetStats,
  bi: _YaGamesPrivate_RegisterCallbacks,
  ai: _YaGamesPrivate_RemoveCallbacks,
  $h: _YaGamesPrivate_Screen_Fullscreen_Exit,
  _h: _YaGamesPrivate_Screen_Fullscreen_Request,
  Zh: _YaGamesPrivate_Screen_Fullscreen_Status,
  Yh: _YaGamesPrivate_ServerTime,
  Xh: _YaGamesPrivate_Shortcut_CanShowPrompt,
  Wh: _YaGamesPrivate_Shortcut_ShowPrompt,
  Vh: _YaGamesPrivate_Storage_Clear,
  Uh: _YaGamesPrivate_Storage_GetItem,
  Th: _YaGamesPrivate_Storage_Key,
  Sh: _YaGamesPrivate_Storage_Length,
  Rh: _YaGamesPrivate_Storage_RemoveItem,
  Qh: _YaGamesPrivate_Storage_SetItem,
  b: ___assert_fail,
...
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["_i"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["$i"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["aj"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["bj"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["dj"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["ej"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["fj"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["gj"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["hj"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["ij"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["jj"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["kj"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["lj"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["mj"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["nj"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["oj"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["pj"])(a0, a1);
};
